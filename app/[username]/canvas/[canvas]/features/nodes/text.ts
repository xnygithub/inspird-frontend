...
import { KONVA_TEXT_CONFIG, TEXT_AREA_EDITING_CONFIG } from "../config";
import { getCenter } from "../functions/utils";

function createText(layer: Konva.Layer) {
    ...
    attachTextLogic(textNode, layer, stage);
    return textNode;
}

function attachTextLogic(
    textNode: Konva.Text,
    layer: Konva.Layer,
    stage: Konva.Stage
) {
