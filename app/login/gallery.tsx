 ...
 *
 * Props:
 *  - images: Array<{ src: string; alt?: string; credit?: string }>
 *  - slideDuration: time each image spends on screen in ms (includes the zoom)
 *  - fadeDuration: crossfade duration between images in ms
 *  - className: container classes (Tailwind)
 */
